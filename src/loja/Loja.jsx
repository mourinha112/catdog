...
/* =====================================================================
   CATALOGO DIGITAL - loja publica de pedidos
...
const Ico = {
  Cao: (props) => (
    <svg width={props.s || 42} height={props.s || 42} viewBox="0 0 24 24" fill={props.c || '#111111'} aria-hidden="true">
      ...
      <circle cx="9.4" cy="11.4" r="1.15" fill="#FAFAFA" />
      <circle cx="14.6" cy="11.4" r="1.15" fill="#FAFAFA" />
      <path d="M12 13.6c1 0 1.6.5 1.6 1.1 0 .8-.8 1.3-1.6 1.3s-1.6-.5-1.6-1.3c0-.6.6-1.1 1.6-1.1z" fill="#FAFAFA" />
    </svg>
  ),
  Gato: (props) => (
    <svg width={props.s || 42} height={props.s || 42} viewBox="0 0 24 24" fill={props.c || '#111111'} aria-hidden="true">
      ...
      <circle cx="9.3" cy="11.2" r="1.15" fill="#FAFAFA" />
      <circle cx="14.7" cy="11.2" r="1.15" fill="#FAFAFA" />
      <path d="M12 13.3c.9 0 1.5.5 1.5 1.1 0 .8-.7 1.3-1.5 1.3s-1.5-.5-1.5-1.3c0-.6.6-1.1 1.5-1.1z" fill="#FAFAFA" />
    </svg>
  ),
  Saco: ({ c1 = '#9E9E9E', c2 = '#6E6E6E', w = 38, h = 49 }) => (
    <svg width={w} height={h} viewBox="0 0 60 76" aria-hidden="true">
      ...
      <rect x="15" y="30" width="30" height="21" rx="5" fill="#FFFFFF" opacity="0.92" />
  ...
  Balde: ({ w = 30, h = 38 }) => (
    <svg width={w} height={h} viewBox="0 0 24 30" aria-hidden="true">
      <path d="M4 9h16l1.6 17.5a2 2 0 0 1-2 2.2H4.4a2 2 0 0 1-2-2.2z" fill="#5E5E5E" />
      <path d="M8 9V6.5a4 4 0 0 1 8 0V9" fill="none" stroke="#6E6E6E" strokeWidth="2" />
      <path d="M8.5 17h7M12 13.5v7" stroke="#FFFFFF" strokeWidth="2.2" strokeLinecap="round" />
    </svg>
  ),
  Carrinho: ({ c = '#fff', s = 22 }) => (
...
// Escala de cinza com hierarquia: o que exige atencao e preto solido,
// o que ja acabou vai clareando.
const ROTULO_STATUS = {
  novo: { texto: 'Aguardando a loja', cor: '#FFFFFF', fundo: '#111111' },
  confirmado: { texto: 'Confirmado', cor: '#111111', fundo: '#DCDCDC' },
  separando: { texto: 'Separando', cor: '#222222', fundo: '#E4E4E4' },
  pronto: { texto: 'Pronto', cor: '#111111', fundo: '#EDEDED' },
  entregue: { texto: 'Entregue', cor: '#767676', fundo: '#F2F2F2' },
  cancelado: { texto: 'Cancelado', cor: '#9E9E9E', fundo: '#F5F5F5' },
};
...
function FotoProduto({ p, tamanho = 'card' }) {
  ...
  // Sem foto, o produto ganha um saco desenhado. Sao seis cinzas
  // diferentes so para dois produtos vizinhos nao ficarem iguais.
  const paletas = [
    ['#3A3A3A', '#1F1F1F'], ['#5E5E5E', '#3D3D3D'], ['#8A8A8A', '#5E5E5E'],
    ['#2B2B2B', '#111111'], ['#6E6E6E', '#4A4A4A'], ['#9E9E9E', '#6E6E6E'],
  ];
      ...
      <div className="lj-app">
        ...
        <div className="lj-topo">
          <div className="lj-topo-linha">
            <img className="lj-topo-logo" src="/logo-branco.png" alt="" />
            <div style={{ flexGrow: 1 }}>
              <div className="lj-ttl lj-topo-oi">Oi! Bora abastecer o pote?</div>
              <div className="lj-topo-sub">{config?.nome_loja || 'Catálogo'}</div>
            </div>
          </div>
        </div>
  ...
  if (tela === 'ok' && pedidoFeito) {
    ...
    return (
      <div className="lj-app" style={{ paddingBottom: 0 }}>
        <BarraProgresso ativa={navegando} />
        <div className="lj-ok">
          <div className="lj-ok-check"><Ico.Check c="#000000" s={48} /></div>
          <div className="lj-ttl" style={{ fontSize: 27, color: '#FFFFFF', marginTop: 18, textAlign: 'center' }}>Pedido enviado!</div>
          <div style={{ fontSize: 14.5, fontWeight: 700, color: 'rgba(255, 255, 255,0.88)', textAlign: 'center', marginTop: 6, maxWidth: 300 }}>
            A loja recebeu seu pedido e confirma em instantes.
          </div>

          <div className="lj-ok-cartao">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
              <span style={{ fontSize: 12, fontWeight: 900, color: '#767676', letterSpacing: 0.6 }}>PEDIDO #{pedidoFeito.id}</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12.5, fontWeight: 700, color: '#767676' }}>
        ...
        <div className="lj-conteudo lj-entra" key={tela}>
          <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
            ...
            <div style={{ flexGrow: 1, minWidth: 0 }}>
              ...
              <div style={{ display: 'inline-block', marginTop: 8, background: '#F0F0F0', borderRadius: 999, padding: '5px 11px', fontSize: 12, fontWeight: 800, color: '#4A4A4A' }}>
              ...
              {!ehUnidade && formato === 'saco' && (
                <button className="lj-opcao is-on" type="button">
                  ...
                  <span style={{ flexGrow: 1, textAlign: 'left' }}>
                    ...
                    <span style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#767676' }}>
                      sai a {money(produto.preco_saco_fechado / (produto.peso_saco_kg || 1))} o quilo
                    </span>
                  </span>
                  <span className="lj-ttl" style={{ fontSize: 18, color: '#111111' }}>{money(produto.preco_saco_fechado)}</span>
                </button>
              )}

              <div className="lj-caixa">
                <div style={{ fontSize: 13, fontWeight: 800, color: '#767676' }}>
                ...
                <div className="lj-stepper">
                  ...
                  <div style={{ flexGrow: 1, textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 12.5, fontWeight: 800, color: '#767676' }}>
        ...
        {!semEstoque && (
          <div className="lj-acao">
            <div style={{ flexShrink: 0 }}>
              <div style={{ fontSize: 11.5, fontWeight: 800, color: '#767676' }}>Total</div>
              <div className="lj-ttl" style={{ fontSize: 23, color: '#111111', lineHeight: 1.05 }}>{money(totalItem)}</div>
            </div>
            <button className="lj-btn lj-btn-primario lj-btn-cresce" onClick={adicionarAoCarrinho}>
              <Ico.Carrinho c="#FFFFFF" /> Adicionar
            </button>
          </div>
        )}
      </div>
        ...
        <div className="lj-conteudo lj-entra" key={tela}>
          {vazio && (
            <div className="lj-vazio">
              <Ico.Carrinho c="#D4D4D4" s={64} />
              <div className="lj-ttl" style={{ fontSize: 18, color: '#111111', marginTop: 12 }}>Seu carrinho está vazio</div>
            ...
            <>
                ...
                {carrinho.map((i) => (
                  <div className="lj-item" key={i.key}>
                    <div style={{ flexGrow: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 12.5, fontWeight: 700, color: '#767676', marginTop: 2 }}>
              ...
              {sugestao && (
                <button className="lj-upsell" onClick={() => adicionarSugestao(sugestao)}>
                  ...
                  <div style={{ flexGrow: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 11.5, fontWeight: 900, color: '#4A4A4A', letterSpacing: 0.5 }}>LEVE TAMBÉM</div>
                    <div className="lj-ttl" style={{ fontSize: 15, color: '#111111', lineHeight: 1.15 }}>
                      {sugestao.marca} {sugestao.nome}
                    </div>
                    <div style={{ fontSize: 13, fontWeight: 800, color: '#111111' }}>{money(precoInicial(sugestao))}</div>
                  </div>
                  <div className="lj-upsell-mais"><Ico.Mais c="#111111" s={18} /></div>
                </button>
              )}
              ...
              <div className="lj-caixa">
                ...
                {entrega === 'retirada' && (
                  <div className="lj-aviso ok"><Ico.Pino c="#111111" /> <span>{config?.endereco_loja}</span></div>
                )}
              </div>

              <button className={`lj-assinatura ${assinar ? 'is-on' : ''}`} onClick={() => setAssinar((v) => !v)}>
                <div style={{ flexGrow: 1 }}>
                  <div className="lj-ttl" style={{ fontSize: 15.5, color: '#111111', lineHeight: 1.15 }}>Repetir esse pedido sozinho</div>
                  <div style={{ fontSize: 12.5, fontWeight: 700, color: '#767676', marginTop: 2 }}>Clube: chega sempre no mesmo dia, sem pedir de novo</div>
                </div>
                <div className={`lj-switch ${assinar ? 'is-on' : ''}`}><i /></div>
              </button>

              {assinar && (
                <div className="lj-caixa" style={{ background: '#F0F0F0', borderColor: '#FFFFFF' }}>
                  <div className="lj-rotulo" style={{ color: '#4A4A4A' }}>DE QUANTO EM QUANTO TEMPO?</div>
                  <div className="lj-chips">
              ...
              <div className="lj-caixa lj-resumo">
                ...
                <div className="lj-resumo-linha">
                  ...
                  <span style={frete === 0 ? { fontWeight: 900, color: '#111111' } : undefined}>{frete === 0 ? 'Grátis' : money(frete)}</span>
                </div>
      ...
      <div className="lj-app">
        ...
        <div className="lj-conteudo lj-entra" key={tela}>
          {numeroSalvo.length < 10 ? (
            <div className="lj-caixa">
              <div className="lj-ttl" style={{ fontSize: 17, color: '#111111' }}>Qual é o seu WhatsApp?</div>
              <div style={{ fontSize: 13.5, fontWeight: 700, color: '#767676', margin: '4px 0 12px' }}>
            ...
            <div className="lj-vazio">
              <Ico.Lista c="#D4D4D4" s={56} />
              <div className="lj-ttl" style={{ fontSize: 18, color: '#111111', marginTop: 12 }}>Nenhum pedido ainda</div>
                ...
                return (
                  <div className="lj-pedido" key={pd.id}>
                    <div className="lj-pedido-topo">
                      <div>
                        <div className="lj-ttl" style={{ fontSize: 16, color: '#171717' }}>Pedido #{pd.id}</div>
                        <div style={{ fontSize: 12, fontWeight: 700, color: '#767676' }}>{dataCurta(pd.created_at)}</div>
                      </div>
                    ...
                    {pd.status !== 'cancelado' && (
                      <button className="lj-btn lj-btn-vazio lj-btn-largo" onClick={() => repetirPedido(pd)}>
                        <Ico.Repetir c="#111111" s={18} /> Pedir de novo
                      </button>
                    )}
                  </div>
                );
      ...
      <div className="lj-app">
        ...
        <div className="lj-topo" style={{ position: 'relative', overflow: 'hidden' }}>
          <div className="lj-topo-linha">
            ...
            <div className="lj-ttl" style={{ fontSize: 18, color: '#FFFFFF' }}>Clube de assinatura</div>
          </div>
          <div className="lj-ttl" style={{ fontSize: 25, color: '#FFFFFF', lineHeight: 1.1, marginTop: 16, maxWidth: 210 }}>
            Seu pet nunca fica sem ração
          </div>
          <div style={{ fontSize: 13.5, fontWeight: 700, color: 'rgba(255, 255, 255,0.88)', marginTop: 6, maxWidth: 210 }}>
            Você pede uma vez e a entrega se repete no dia e horário que escolher.
          </div>
          <svg className="lj-clube-pata topo" viewBox="0 0 100 100" aria-hidden="true">
        <circle cx="28" cy="30" r="11" /><circle cx="50" cy="21" r="12" />
        <circle cx="72" cy="30" r="11" /><circle cx="84" cy="52" r="10" />
        <path d="M50 44c17 0 29 12 29 25 0 12-13 17-29 17s-29-5-29-17c0-13 12-25 29-25z" />
      </svg>
        </div>
        ...
        <div className="lj-conteudo lj-entra" key={tela}>
          {[
            ...
            <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 13, background: '#fff', border: '2px solid #E6E6E6', borderRadius: 20, padding: 13 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 46, height: 46, borderRadius: 15, background: '#FFFFFF', flexShrink: 0 }}>
                <Ico.Repetir />
              </div>
              <div>
                <div className="lj-ttl" style={{ fontSize: 16, lineHeight: 1.15 }}>{t}</div>
                <div style={{ fontSize: 12.5, fontWeight: 700, color: '#767676' }}>{s}</div>
              </div>
            </div>
          ))}
    ...
    return (
      <div className="lj-app">
        ...
        <div className="lj-barra" style={{ flexDirection: 'column', alignItems: 'stretch', gap: 12, paddingBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <button className="lj-icone-btn" onClick={() => setTela('carrinho')} aria-label="Carrinho">
              <Ico.Carrinho />
              {totalItens > 0 && <span className="lj-badge" style={{ position: 'absolute', top: -4, right: -4, transform: 'none', background: '#FFFFFF', color: '#111111' }}>{totalItens}</span>}
            </button>
          </div>
          <input
            value={busca}
            ...
            style={{ width: '100%', border: 0, borderRadius: 14, padding: '12px 13px', fontSize: 15, fontWeight: 700, background: '#FFFFFF', color: '#111111', outline: 'none' }}
          />
        </div>
        ...
        <div className="lj-conteudo lj-entra" key={tela}>
          ...
          <div style={{ fontSize: 13.5, fontWeight: 800, color: '#767676' }}>
          ...
          {filtrados.length === 0 && (
            <div style={{ textAlign: 'center', padding: '26px 14px', background: '#fff', border: '2px dashed #E6E6E6', borderRadius: 20 }}>
              <div className="lj-ttl" style={{ fontSize: 16, color: '#111111' }}>Nada com esses filtros</div>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#767676', marginTop: 4 }}>
  ...
  return (
    <div className="lj-app">
      ...
      <div className="lj-topo">
        ...
        <div className="lj-topo-local">
          ...
          <span style={{ flexGrow: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {endereco ? `Entregar em ${endereco}` : (config?.endereco_loja || 'Toque para informar o endereço')}
          </span>
      ...
      <div className="lj-conteudo lj-entra" key={tela}>
        ...
        <div>
          <div className="lj-ttl" style={{ fontSize: 14, color: '#767676', letterSpacing: 0.4 }}>OU VÁ DIRETO PELO PERFIL</div>
        ...
        {ultimoPedido?.itens?.length > 0 && (
          <button className="lj-repetir" onClick={repetirUltimo}>
            ...
            <div style={{ flexGrow: 1 }}>
              <div className="lj-ttl" style={{ fontSize: 16, color: '#111111', lineHeight: 1.15 }}>Pedir o mesmo de novo</div>
              <div style={{ fontSize: 12.5, fontWeight: 700, color: 'rgba(0, 0, 0,0.72)' }}>
        ...
        <button className="lj-clube" onClick={() => setTela('clube')}>
          ...
          <div className="lj-ttl" style={{ fontSize: 20, color: '#FFFFFF', lineHeight: 1.1, marginTop: 9 }}>Nunca mais fique sem ração</div>
          <div style={{ fontSize: 13, fontWeight: 700, color: 'rgba(255, 255, 255,0.86)', marginTop: 4 }}>
            Peça uma vez e repete sozinho, no dia que você escolher
          </div>
          <svg className="lj-clube-pata" viewBox="0 0 100 100" aria-hidden="true">
          <circle cx="28" cy="30" r="11" /><circle cx="50" cy="21" r="12" />
          <circle cx="72" cy="30" r="11" /><circle cx="84" cy="52" r="10" />
          <path d="M50 44c17 0 29 12 29 25 0 12-13 17-29 17s-29-5-29-17c0-13 12-25 29-25z" />
        </svg>
        ...
        {maisPedidos.length > 0 && (
          <div>
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
              <div className="lj-ttl" style={{ fontSize: 18, color: '#111111' }}>Mais pedidos da loja</div>
              <button style={{ background: 'transparent', fontSize: 13.5, fontWeight: 800, color: '#111111', padding: 4 }} onClick={() => { setEspecie('todos'); setPerfil('todos'); setPorte('todos'); setTela('catalogo'); }}>
                ver tudo
              </button>
            </div>
              ...
              {maisPedidos.map((p) => (
                <button key={p.id} className="lj-produto" onClick={() => abrirProduto(p)}>
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#767676' }}>a partir de</div>
                    <div className="lj-ttl" style={{ fontSize: 16, color: '#111111' }}>{money(precoInicial(p))}</div>
                  </div>
                </button>
              ))}
            </div>
        ...
        <footer className="lj-rodape">
          <img src="/logo-branco.png" alt="" />
          <div className="lj-rodape-nome">{config?.nome_loja || 'Cat & Dog Pet Shop'}</div>
          {config?.endereco_loja && <div>{config.endereco_loja}</div>}
          {config?.email_loja && <div>{config.email_loja}</div>}
          {config?.cnpj_loja && <div className="lj-rodape-cnpj">CNPJ {config.cnpj_loja}</div>}
        </footer>

        {produtos.length === 0 && (
          <div className="lj-vazio">
            <div className="lj-ttl" style={{ fontSize: 17, color: '#111111' }}>Catálogo em montagem</div>
            <div style={{ fontSize: 13.5, fontWeight: 700, marginTop: 4 }}>
...
function Abas({ tela, setTela, totalItens, aoAbrirMeus }) {
  const cor = (t) => (tela === t ? '#111111' : '#A6A6A6');
  return (
